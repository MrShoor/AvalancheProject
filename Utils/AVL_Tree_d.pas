...
var h: string;
  ...
  begin
    ...
    b:=Prefix+IntToHex(NativeInt(ANode.Data),8)+'    '
        +'  Self='+IntToHex(NativeInt(ANode),8)
        +'  Parent='+IntToHex(NativeInt(ANode.Parent),8)
