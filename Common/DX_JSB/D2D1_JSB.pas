...
uses
  Windows, SysUtils, MultiMon, Graphics, {$IFDEF UseJSBErrors} UDirectXErrors, {$ENDIF} DXTypes_JSB, DXGI_JSB, DirectWrite_JSB, D3D10_1_JSB;
...
//!!!  D2D_ERROR_INSUFFICIENT_BUFFER=HRESULT_FROM_WIN32(ERROR_INSUFFICIENT_BUFFER);
  ...
  D2D_ERROR_UNSUPPORTED_PIXEL_FORMAT=HResult($88982F80); // JSB: From "wincodec.h"
...
initialization
begin
  AddDirectXHResultToStringHandler(D2D1_HResultToString);
end;
{$ENDIF}
